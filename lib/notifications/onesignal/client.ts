export const ONESIGNAL_SDK_VERSION = "160609";

export const ONESIGNAL_SDK_SCRIPT_SRC = `/vendor/onesignal/v16/OneSignalSDK.page.es6.js?v=${ONESIGNAL_SDK_VERSION}`;

export const ONESIGNAL_SDK_SW_SCRIPT_SRC =
