-- product_catalog.id / listings.product_id are TEXT (e.g. OFFICIAL-50301), not UUID.

DROP FUNCTION IF EXISTS public.get_merchant_product_analytics(uuid, text, integer, integer);
