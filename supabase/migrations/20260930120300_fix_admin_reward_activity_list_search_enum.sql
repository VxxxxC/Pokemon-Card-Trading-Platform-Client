-- Fix rpc_admin_list_reward_activities search: use reward_type / text compare (not reward_template_type).

DROP FUNCTION IF EXISTS public.rpc_admin_list_reward_activities(TEXT, INTEGER, INTEGER);
DROP FUNCTION IF EXISTS public.rpc_admin_list_reward_activities(TEXT, INTEGER, INTEGER, TEXT);
