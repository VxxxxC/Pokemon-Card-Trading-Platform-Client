-- Fix payout_request_status ('completed' not 'paid') + E2E merchant refund-eligible seed.
...
CREATE OR REPLACE FUNCTION public.rpc_e2e_seed_merchant_direct_refund_eligible_order(
    p_listing_id UUID,
    p_buyer_id UUID,
...
REVOKE ALL ON FUNCTION public.rpc_e2e_seed_merchant_direct_refund_eligible_order(UUID, UUID, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.rpc_e2e_seed_merchant_direct_refund_eligible_order(UUID, UUID, TEXT)
    TO service_role;
