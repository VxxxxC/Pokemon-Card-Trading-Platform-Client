-- Atomic merchant KYC application submit: kyc_applications + kyc_documents in one transaction.
-- Called from server action via service_role (tables are RLS fail-closed).
