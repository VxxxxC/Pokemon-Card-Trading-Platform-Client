-- Align check_in_cycle_day progress with CheckInCard: when not checked in today but
-- last check-in was yesterday, use projected streak+1 for cycle day (same as UI).
