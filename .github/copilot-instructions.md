...
When the user asks to create/modify/edit/amend a page, a component, or UI feature, you MUST strictly enforce the following 3-step workflow. **Do not skip directly to writing code.**
...
- **Step 1: Taste & Foundation (`taste-design`)**
  ...
  - _Goal:_ Enforce premium Fintech aesthetics (e.g., no `#000000`, no `Inter` font, no generic AI phrasing, use Spring Physics motion).

- **Step 2: Controlled Generation (`stitch-design`)**
  - _Prompting Rule:_ Always remind the agent to "Strictly adhere to the anti-patterns and aesthetic rules in `.stitch/designs/DESIGN.md`. Do not hallucinate generic metrics."
