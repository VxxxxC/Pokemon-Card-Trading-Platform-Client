...
| Auth Escrow v2 (鑑定兩段順豐 · single capture · fail 追償) | 🟢 Phase B–D Ready | 🟡 Partner QA | migrations **`20260901120000`**–**`20260901170000`** + **`20260902100000`** + **`20260909100000`** + **`20260910100000`** (Phase D coupons) | `checkout/[id]` 驗四行 · `/admin/grading` **待追償** tab · seller pending banner · `MerchantOrderDetailView` gross/deduction/net | [plan](./follow-up/auth-escrow-v2/plan.md) · [phase-d-plan](./follow-up/auth-escrow-v2/phase-d-plan.md) · [backend](./follow-up/auth-escrow-v2/backend.md) · [frontend](./follow-up/auth-escrow-v2/frontend.md) |
| Platform rewards v2 — Phase 2b (merchant_auth checkout coupons) | 🟢 Ready | 🟡 Partner QA | **`20260816120000`** + **`20260910100000`** (v2 amounts), grading-fail coupon restore, `checkout-coupons.ts` `useAuth` | `checkout/[id]` → `AuthEscrowReview` + auth toggle picker | [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) · **[QA](./follow-up/platform-rewards-v2/QA_CHECKLIST.md)** Part D · E2E `e2e/platform-rewards-phase2.spec.ts` (B2b) |
