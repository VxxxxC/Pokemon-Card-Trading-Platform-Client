...
| Merchant storefront (`/marketplace/[id]`) | ✅ Ready | ✅ Wired | `getMarketplaceSellerProfile`, `searchMarketplaceSellerListings`, **`getMarketplaceSellerListingDetail`**, `search_marketplace_seller_listings` RPC, `lib/marketplace/load-seller-profile.ts`, `lib/marketplace/load-seller-listing-detail.ts`, `lib/marketplace/map-seller-listing.ts`, migration **`20260707160000`** | `app/marketplace/[id]/`, `app/marketplace/[id]/product/[productId]/`, `useMarketplaceSellerSearch` | [backend](./follow-up/marketplace-storefront/backend.md) · [frontend](./follow-up/marketplace-storefront/frontend.md) · **[partner report](./follow-up/marketplace-storefront/PARTNER_REPORT.md)** |
...
| Home page sections (wishlist / merchant / C2C) | ✅ Ready | ✅ Wired | `app/actions/home.ts`, `getHomeWishlistPreview`, `lib/home/load-home-listings.ts`, `lib/wishlist/pricing.ts`, `lib/home/perf-log.ts` | `app/page.tsx`, `HomePageShell.tsx`, `Home*SectionData.tsx`, `WishlistTicker.tsx`, `PremiumMarket.tsx`, `NewArrivals.tsx`, `HeroSearch.tsx` | [backend](./follow-up/home-sections/backend.md) · [frontend](./follow-up/home-sections/frontend.md) · [PERF](./follow-up/home-sections/PERF_REPORT.md) · **[partner report](./follow-up/home-sections/PARTNER_REPORT.md)** |
| User collection portfolio (hobby + sell prefill) | ✅ Ready (pushed) | ✅ Wired | `getCollectionPageBootstrap`, `lib/collection/load-user-collection.ts`, SSR `UserCollectionPageData.tsx`, `lib/collection/perf-log.ts` | `UserCollectionClient.tsx`, `useCollection.ts` (`initialData`), `useWishlist.ts` (`deferLoad`) | [backend](./follow-up/user-collection/backend.md) · [frontend](./follow-up/user-collection/frontend.md) · [PERF](./follow-up/user-collection/PERF_REPORT.md) — ⏳ wishlist pagination; ⏳ home `PortfolioRewards` |
| User inventory (seller listings by product) | ✅ Ready | ✅ Wired (user) + perf | `app/actions/inventory.ts`, `lib/listings/load-user-inventory.ts`, `app/actions/listings.ts` (`incrementListingView`), migrations `20260706120000`–`20260706140000` ✅ remote | `inventory/page.tsx`, `UserInventoryPageData.tsx`, `useInventory.ts`, `InventoryAccordion.tsx` | [backend](./follow-up/user-inventory/backend.md) · [frontend](./follow-up/user-inventory/frontend.md) · **[PERF_REPORT](./follow-up/user-inventory/PERF_REPORT.md)** · [partner report](./follow-up/user-inventory/PARTNER_REPORT.md) — ⏳ merchant inventory page |
| Member profile dashboard (overview) | ✅ Ready | ✅ Wired | `app/actions/member-dashboard.ts`, `UserOverviewPageData.tsx`, `lib/dashboard/*`, `lib/titles/member-title-progress.ts`; SSR streaming + perf log | `page.tsx`, `UserOverviewClient.tsx`, `useMemberDashboard.ts`, `UserProfileDashboardShell.tsx` | [backend](./follow-up/member-dashboard/backend.md) · [frontend](./follow-up/member-dashboard/frontend.md) · **[partner report](./follow-up/member-dashboard/PARTNER_REPORT.md)** — ⏳ merchant dashboard titles |
