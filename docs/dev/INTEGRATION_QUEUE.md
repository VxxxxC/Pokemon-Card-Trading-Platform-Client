...
| Platform rewards v2 — Phase 2 (merchant_direct checkout coupons) | ✅ Ready | ✅ Wired | migrations **`20260815120000`**, **`20260815130000`** (STABLE subsidy fix), **`20260830120000`** (coupon reserve FSM V1–V3), **`20260831120000`** (security R-01–R-03), `app/actions/checkout-coupons.ts`, `merchant-checkout.ts`, `execute-connect-payout.ts`, webhook coupon release, cron **`/api/cron/release-stale-coupon-reserves`** | `checkout/[id]` → `CheckoutCouponPicker`, summary 平台優惠行 | [plan](./follow-up/platform-rewards-v2/plan.md) · [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) · **[QA](./follow-up/platform-rewards-v2/QA_CHECKLIST.md)** · **[Partner checklist](./follow-up/platform-rewards-v2/PARTNER_CHECKLIST.md)** · E2E `e2e/platform-rewards-phase2.spec.ts` · Vitest `coupon-fsm.integration.test.ts` (I-C2–I-C4) · `coupon-security.integration.test.ts` (I-S1–I-S3) |
...
| Platform rewards v2 — Phase 3 (flash campaigns) | ✅ Ready | 🟡 Partner QA | migration **`20260817120000`**, `app/actions/reward-flash.ts` | `/profile/user/rewards` → **限時搶券** | [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) · **[QA](./follow-up/platform-rewards-v2/QA_CHECKLIST.md)** Part E · E2E `e2e/platform-rewards-phase3.spec.ts` |
| Platform rewards v2 — Admin activity workflow refactor | ✅ Ready | ✅ Wired | migration **`20260819120000`**, `app/actions/admin-reward-activities.ts`, `RewardActivityForm.tsx` | `/admin/campaigns` 統一列表 · `/admin/campaigns/new` · `/admin/campaigns/[id]` | [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) — ⏳ **Phase 4 積分商城 on hold** |
