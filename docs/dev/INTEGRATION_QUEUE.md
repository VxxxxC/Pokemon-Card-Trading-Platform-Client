...
| Admin payouts（財務與結算） | ✅ Ready | 🟡 Partial | `app/actions/admin-payouts.ts`, `lib/admin-payouts/*`, migration **`20260801120000`**, `scripts/dev/seed-fps-payout-requests.sql` | `/admin/payouts`, `FpsLedgerTab.tsx`, `MerchantConnectLedgerTab.tsx` | [plan](./follow-up/admin-payouts/plan.md) · [backend](./follow-up/admin-payouts/backend.md) · [frontend](./follow-up/admin-payouts/frontend.md) — Merchant ledger ✅; FPS ledger MVP ✅; ⏳ buyer-confirm pipeline |
