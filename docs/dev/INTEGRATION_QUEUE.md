...
| Platform rewards v2 — Phase 1 (admin templates + wizard) | ✅ Ready | 🟡 Partner QA | `app/actions/admin-rewards.ts`, `lib/admin-rewards/*`, migration **`20260813120000`**, wizard `app/admin/campaigns/wizard/*` | `/admin/campaigns` → **獎勵模板** | [plan](./follow-up/platform-rewards-v2/plan.md) · [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) · **[QA](./follow-up/platform-rewards-v2/QA_CHECKLIST.md)** |
| Platform rewards v2 — Phase 2 (merchant_direct checkout coupons) | ✅ Ready | 🟡 Partner QA | migration **`20260815120000`**, `app/actions/checkout-coupons.ts`, `merchant-checkout.ts`, `execute-connect-payout.ts`, webhook coupon release | `checkout/[id]` → `CheckoutCouponPicker`, summary 平台優惠行 | [plan](./follow-up/platform-rewards-v2/plan.md) · [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) · **[QA](./follow-up/platform-rewards-v2/QA_CHECKLIST.md)** — ⏳ Phase 2b auth · Phase 3 flash |
