...
| Auth Escrow v2 (鑑定兩段順豐 · single capture · fail 追償) | 🟢 Phase B + v2.1 Ready | 🟡 Partner QA | migrations **`20260901120000`** + **`20260901130000`** + **`20260901140000`**; checkout 四行 breakdown · intake 不 capture · pass 全額 capture | `checkout/[id]` 驗四行 · `/admin/grading` 新單 $310 一次 capture · Phase C 追償 UI pending | [plan](./follow-up/auth-escrow-v2/plan.md) · [backend](./follow-up/auth-escrow-v2/backend.md) · [frontend](./follow-up/auth-escrow-v2/frontend.md) · **blocks** Rewards Phase 2b until Phase D |
