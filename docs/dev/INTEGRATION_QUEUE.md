...
| Platform rewards v2 — Phase 2 (merchant_direct checkout coupons) | ✅ Ready | ✅ Wired | migrations **`20260815120000`**, **`20260815130000`** (STABLE subsidy fix), `app/actions/checkout-coupons.ts`, `merchant-checkout.ts`, `execute-connect-payout.ts`, webhook coupon release | `checkout/[id]` → `CheckoutCouponPicker`, summary 平台優惠行 | [plan](./follow-up/platform-rewards-v2/plan.md) · [backend](./follow-up/platform-rewards-v2/backend.md) · [frontend](./follow-up/platform-rewards-v2/frontend.md) · **[QA](./follow-up/platform-rewards-v2/QA_CHECKLIST.md)** · **[Partner checklist](./follow-up/platform-rewards-v2/PARTNER_CHECKLIST.md)** · E2E `e2e/platform-rewards-phase2.spec.ts` |
