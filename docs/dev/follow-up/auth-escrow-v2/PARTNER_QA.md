...
| # | 步驟 | 預期 | 通過 |
|---|------|------|------|
| P2.1 | Admin 鑑定 **fail**（`fault_party = seller`） | 買家全額退款 / PI void；券 `is_used` 清除 | ☐ |
...
Partner 完成 P0–P2 後，於 `INTEGRATION_QUEUE.md` 將 **Auth Escrow v2** 與 **Rewards Phase 2b** 標為 ✅ Partner QA。
