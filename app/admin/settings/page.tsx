...
export default function AdminSettingsPage() {
  return (
    <div className="max-w-180 space-y-6">
      ...
      {/* ── Scraper Settings ──────────────────────────────────────────── */}
      {/* TODO: [server] "立即觸發" button has no handler — must call server action to trigger Mercari/SKUNK scraper job; scraper status ("上次: 2小時前") is hardcoded */}
      ...
      {/* TODO: [server] "更換" button has no handler — must open a modal to securely update API key via server action with encryption at rest */}
      <section
