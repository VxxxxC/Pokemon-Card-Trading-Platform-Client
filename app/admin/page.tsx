...
// TODO [database]: Replace with Supabase aggregation — query `orders`, `stripe_payouts` and `sessions` tables for live platform metrics
...
// TODO [database]: Replace with Supabase Realtime subscription on `orders` table JOIN `users` and `listings`, limit 5, order by created_at DESC
...
// TODO [database]: Replace with live health checks — ping each service endpoint and measure latency; update status in real-time
const systemStatus = [
        ...
        <div className="flex items-start justify-between gap-3 mb-2">
          <div className="flex-1 min-w-0">
            ...
            <p className="font-mono text-[12px] text-text-secondary mt-0.5">
              {/* TODO [database]: Replace hardcoded timestamp with real server time — use new Date().toLocaleString('zh-TW', { timeZone: 'Asia/Hong_Kong' }) or server-side Date */}
