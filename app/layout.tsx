...
// 🟢 提純防線一：將所有 appleWebApp 屬性徹底抽離，防止 Next.js 引擎進行標籤分組與亂序編排
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      // 🟢 保底防線二：硬編碼 HTML 畫布背景色，在頁面完全水合前，強制把原生基底底色鎖死在炭黑色
      style={{ backgroundColor: "#17130f" }}
    >
      <head>
        {/* 🚀 終極絕殺：物理順序完全鎖死！iOS 必須最優先讀取到這三行 Meta 標籤 */}
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta
          name="apple-mobile-web-app-status-bar-style"
          content="black-translucent"
        />
        <meta name="apple-mobile-web-app-title" content="HKCardVault" />

        {/* 官方保底 Apple Icon */}
        <link rel="apple-touch-icon" href="/icons/icon-512x512.png" />

        {/* 🚀 物理順序防線三：緊貼在 Meta 下方，全量鋪設最工整的直向與橫向 40+ 條全裝置適配鏈路 */}
        {/* LANDSCAPE SCREENS */}
        <link
