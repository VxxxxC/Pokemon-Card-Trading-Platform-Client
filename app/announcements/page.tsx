...
export default function PublicAnnouncementsPage() {
  ...
  // TODO: [Supabase Integration] Fetch all announcements from announcements table via Server Action / Supabase query
  const announcementsList: Announcement[] = MOCK_ANNOUNCEMENTS;

  // Categorize active vs past announcements
  const { activeAnnouncements, pastAnnouncements, now } = useMemo(() => {
    const nowDate = new Date();
    const activeList: Announcement[] = [];
    const pastList: Announcement[] = [];
  ...
  const currentDisplayList = activeTab === "active" ? activeAnnouncements : pastAnnouncements;
