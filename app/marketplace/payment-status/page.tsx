          ...
          {status === "success" ? (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h1 className="font-sans font-bold text-[22px] text-[#eae1da]">交易付款成功</h1>
                <p className="font-sans text-[13px] text-[#d4c4b7]">
                  您已成功支付 10% Escrow 交易定金！實物資產已即時進入託管及發貨鑑定流程。
                </p>
              </div>
              ...
              <div className="bg-[#17130f] p-4 rounded-xl border border-[rgba(237,232,224,0.04)] font-mono text-[11px] text-[#d4c4b7] text-left space-y-1.5">
                <p><span className="text-[#50453b]">訂單編號:</span> {mockOrderId}</p>
                <p className="truncate"><span className="text-[#50453b]">Stripe 流水號:</span> {mockStripeId}</p>
                <p><span className="text-[#50453b]">支付保障:</span> 🔒 ESCROW STANDARD DEPOSIT</p>
                <p><span className="text-[#50453b]">確認機制:</span> ⚡ RLS ATOMIC LOCK APPROVED</p>
              </div>

              <p className="font-mono text-[11px] text-[#8c7355] animate-pulse">
                🔄 將於 {counter} 秒內自動跳轉至訂單管理器追蹤詳情...
              </p>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h1 className="font-sans font-bold text-[22px] text-[#eae1da]">交易付款失敗</h1>
                <p className="font-sans text-[13px] text-[#d4c4b7]">
                  很抱歉，本次交易下單失敗。可能原因：
                </p>
              </div>
              ...
              <div className="bg-[#17130f] p-4 rounded-xl border border-[rgba(239,68,68,0.12)] font-mono text-[11px] text-[#ef4444] text-left space-y-1.5">
                ...
                <p>🔴 競態提示: 或該卡牌現貨剛剛已被其他玩家優先直接購買截胡。</p>
              </div>
