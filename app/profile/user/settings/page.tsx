        ...
        <form className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center h-11 bg-bg-elevated border border-[rgba(237,232,224,0.12)] rounded-xl overflow-hidden">
              <span className="px-3 font-mono text-[13px] text-text-disabled border-r border-[rgba(237,232,224,0.08)]">
                @
              </span>
              <input
                id="handle"
        ...
        <div className="flex items-start gap-3 mb-4">
          ...
          <div>
            ...
            <p className="font-sans text-[13px] text-text-secondary mt-0.5">
              通過 KYC 審核後，即可開設店舖並上架卡牌銷售，解鎖 Stripe Connect
              金流功能。
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          {[
            ...
            >
              ...
              <div
                className={`w-10 h-5 rounded-full flex items-center transition-colors ${on ? "bg-brand justify-end pr-0.5" : "bg-bg-hover justify-start pl-0.5"}`}
              >
