    ...
    <div className="max-w-160 space-y-6">
      <section aria-labelledby="shop-info-heading" className="bg-bg-card rounded-2xl border border-[rgba(237,232,224,0.08)] p-5">
        ...
        <form className="space-y-4">
          <div>
            {/* TODO: [database] defaultValue="レン精選卡牌" is hardcoded — replace with value from `merchant_profiles.shop_name` queried for current user */}
          ...
          {/* TODO: [server] "儲存店舖資料" form submit has no handler — must call server action to UPDATE `merchant_profiles.shop_name` for current user */}
