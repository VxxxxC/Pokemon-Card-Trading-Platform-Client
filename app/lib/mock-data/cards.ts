...
export const INITIAL_LISTINGS: UnifiedProductSpec[] = [
...

  {
    id: "sm4p-119",
    cardNo: "sm4p-119",
    name: "Lillie Full Art (莉莉艾 SR)",
    jpName: "リーリエ SR",
    set: "GX Battle Boost",
    rarity: "SR",
    delta: 500,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-lillie/600/420"],
    ...
    moveDamage: "支援者卡",
    artist: "Naoki Saito",
    soldHistory: [{ date: "2026-06-20", grade: "ARS 10", price: 38000 }],
    chartPoints: [{ day: 1, date: "06-01", price: 38000 }],
    sellOrders: [
      {
        sellerName: "尖沙咀卡神",
        sellerId: "HKCV-9900-11A",
        price: 38000,
        sellerRating: 4.9,
        customGrade: { authority: "ARS", score: "10" },
      },
    ],
  },
  {
    id: "s4a-308",
    cardNo: "s4a-308",
    name: "Charizard VMAX Shiny (黑噴 VMAX SSR)",
    jpName: "リザードン VMAX SSR",
    set: "Shiny Star V",
    rarity: "UR",
    delta: 200,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-charvmax/600/420"],
    type: "火 (Fire)",
    stage: "VMAX",
    weakness: "水 x2",
    retreatCost: "◆◆◆",
    moveDamage: "超極巨地獄滅火 300",
    artist: "Kyohei Oka",
    soldHistory: [{ date: "2026-06-22", grade: "BGS 10 Black Label", price: 125000 }],
    chartPoints: [{ day: 1, date: "06-01", price: 125000 }],
    sellOrders: [
      {
        sellerName: "中環拍賣閣",
        sellerId: "HKCV-1234-56X",
        price: 125000,
        sellerRating: 5.0,
        customGrade: { authority: "BGS", score: "10 Black Label" },
      },
    ],
  },
  {
    id: "mcd-001",
    cardNo: "mcd-001",
    name: "Pikachu Gold Star (皮卡丘金星)",
    jpName: "ピカチュウ ☆",
    set: "McDonalds Promo",
    rarity: "SR",
    delta: 150,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-pika-star/600/420"],
    type: "電 (Lightning)",
    stage: "Basic",
    weakness: "格鬥 x2",
    retreatCost: "◆",
    ...
    soldHistory: [{ date: "2026-06-25", grade: "ACE 10 Gem Mint", price: 4500 }],
    chartPoints: [{ day: 1, date: "06-01", price: 4500 }],
    sellOrders: [
      {
        sellerName: "灣仔潮流卡舖",
        sellerId: "HKCV-6622-11H",
        price: 4500,
        sellerRating: 4.4,
        customGrade: { authority: "ACE", score: "10 Gem Mint" },
      },
    ],
  },
  {
    id: "star-002",
    cardNo: "star-002",
    name: "Mew Gold Star (夢幻金星)",
    jpName: "ミュウ ☆",
    set: "Gift Box Mew",
    rarity: "UR",
    delta: 180,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-mew-star/600/420"],
    type: "超能力 (Psychic)",
    stage: "Basic",
    weakness: "惡 x2",
    retreatCost: "◆",
    moveDamage: "全能模仿",
    artist: "Masakazu Fukuda",
    soldHistory: [{ date: "2026-06-26", grade: "SGC 10 Pristine", price: 6200 }],
    chartPoints: [{ day: 1, date: "06-01", price: 6200 }],
    sellOrders: [
      {
        sellerName: "九龍城無框生品",
        sellerId: "HKCV-9977-11D",
        price: 6200,
        sellerRating: 4.4,
        customGrade: { authority: "SGC", score: "10 Pristine" },
      },
    ],
  },
  {
    id: "sgg-020",
    cardNo: "sgg-020",
    name: "Gengar VMAX Alt Art (耿鬼 VMAX SA)",
    jpName: "ゲンガー VMAX SA",
    set: "High-Class Deck Gengar",
    rarity: "SAR",
    delta: 80,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-gengarvmax/600/420"],
    type: "惡 (Dark)",
    stage: "VMAX",
    weakness: "格鬥 x2",
    retreatCost: "◆◆◆",
    ...
    soldHistory: [{ date: "2026-06-21", grade: "KSA 9.5 NMM", price: 3200 }],
    chartPoints: [{ day: 1, date: "06-01", price: 3200 }],
    sellOrders: [
      {
        sellerName: "石籬二手精品鋪",
        sellerId: "HKCV-1188-22E",
        price: 3200,
        sellerRating: 4.7,
        customGrade: { authority: "KSA", score: "9.5 NMM" },
      },
    ],
  },
  {
    id: "s7r-083",
    cardNo: "s7r-083",
    name: "Rayquaza VMAX Alt Art (烈空坐 VMAX SA HR)",
    jpName: "レックウザ VMAX SA",
    set: "Blue Sky Stream",
    rarity: "UR",
    delta: 150,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-rayvmax/600/420"],
    type: "龍 (Dragon)",
    stage: "VMAX",
    weakness: "無色 x2",
    retreatCost: "◆◆",
    moveDamage: "極巨烈空破 340",
    artist: "GIDORA",
    soldHistory: [{ date: "2026-06-18", grade: "PSA 10", price: 18500 }],
    chartPoints: [{ day: 1, date: "06-01", price: 18500 }],
    sellOrders: [
      {
        sellerName: "渡邊道館",
        sellerId: "HKCV-8839-44A",
  ...
  },
  {
    id: "s11-111",
    cardNo: "s11-111",
    name: "Giratina V Alt Art (騎拉帝納 V SA SR)",
    jpName: "ギラティナ V SA",
    set: "Lost Abyss",
    rarity: "SAR",
    delta: 90,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-giraalt/600/420"],
    type: "龍 (Dragon)",
    stage: "Basic",
    weakness: "無色 x2",
    retreatCost: "◆◆",
    moveDamage: "失落衝擊 280",
    artist: "Shinji Kanda",
    soldHistory: [{ date: "2026-06-19", grade: "PSA 9", price: 4200 }],
    chartPoints: [{ day: 1, date: "06-01", price: 4200 }],
    sellOrders: [
      {
        sellerName: "沙田競技商城",
        sellerId: "HKCV-8844-77M",
  ...
  },
  {
    id: "s4a-198",
    cardNo: "s4a-198",
    name: "Marnie Full Art (瑪俐 SR)",
    jpName: "マリィ SR",
    set: "Shiny Star V",
    rarity: "SR",
    delta: 110,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-marnie/600/420"],
    type: "Trainer (Trainer)",
    stage: "Trainer",
    weakness: "無",
    retreatCost: "無",
    moveDamage: "支援者卡",
    artist: "Naoki Saito",
    soldHistory: [{ date: "2026-06-15", grade: "CGC 10", price: 6500 }],
    chartPoints: [{ day: 1, date: "06-01", price: 6500 }],
    sellOrders: [
      {
        sellerName: "元朗動漫城",
        sellerId: "HKCV-5544-77C",
        price: 6500,
        sellerRating: 4.9,
        customGrade: { authority: "CGC", score: "10" },
      },
    ],
  },
  {
    id: "sm2p-056",
    cardNo: "sm2p-056",
    name: "Acerola Full Art (阿塞羅拉 SR)",
    jpName: "アセロラ SR",
    set: "Facing a New Trial",
    rarity: "SR",
    delta: 300,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-acerola/600/420"],
    type: "Trainer (Trainer)",
    stage: "Trainer",
    weakness: "無",
    retreatCost: "無",
    moveDamage: "支援者卡",
    artist: "Naoki Saito",
    soldHistory: [{ date: "2026-06-12", grade: "CGC 9", price: 12000 }],
    chartPoints: [{ day: 1, date: "06-01", price: 12000 }],
    sellOrders: [
      {
        sellerName: "銅鑼灣收藏家",
        sellerId: "HKCV-5566-77C",
  ...
  },
  {
    id: "sm9-105",
    cardNo: "sm9-105",
    name: "Latias & Latios GX Alt Art (拉帝亞斯 & 拉帝歐斯 GX SA SR)",
    jpName: "ラティアス&ラティオス GX SA",
    set: "Tag Bolt",
    rarity: "SR",
    delta: 400,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-lati/600/420"],
    type: "龍 (Dragon)",
    stage: "Basic",
    weakness: "妖精 x2",
    retreatCost: "◆◆",
    moveDamage: "毀滅奇點 240",
    artist: "shizurow",
    soldHistory: [{ date: "2026-06-24", grade: "Raw Card", price: 15800 }],
    chartPoints: [{ day: 1, date: "06-01", price: 15800 }],
    sellOrders: [
      {
        sellerName: "秋葉原海外直送店",
        sellerId: "HKCV-4455-66C",
  ...
  },
  {
    id: "sm3p-056",
    cardNo: "sm3p-056",
    name: "Guzma Full Art (古茲馬 SR)",
    jpName: "グズマ SR",
    set: "Did You See the Rainbow?",
    rarity: "SR",
    delta: 20,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-guzma/600/420"],
    type: "Trainer (Trainer)",
    stage: "Trainer",
    weakness: "無",
    retreatCost: "無",
    ...
    soldHistory: [{ date: "2026-06-08", grade: "Raw Card", price: 450 }],
    chartPoints: [{ day: 1, date: "06-01", price: 450 }],
    sellOrders: [
      {
        sellerName: "元朗李生精品",
        sellerId: "HKCV-2233-44B",
  ...
  },
  {
    id: "sm-ray",
    cardNo: "sm-ray",
    name: "Rayquaza Gold Star (烈空坐金星)",
    jpName: "レックウザ ☆",
    set: "Clash of the Blue Sky",
    rarity: "UR",
    delta: 800,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-raystar/600/420"],
    type: "龍 (Dragon)",
    stage: "Basic",
    weakness: "無色 x2",
    retreatCost: "◆◆",
    moveDamage: "神聖爆裂 150",
    artist: "Masakazu Fukuda",
    soldHistory: [{ date: "2026-06-27", grade: "PSA 10", price: 98000 }],
    chartPoints: [{ day: 1, date: "06-01", price: 98000 }],
    sellOrders: [
      {
        sellerName: "中環拍賣閣",
        sellerId: "HKCV-1234-56X",
  ...
  },
  {
    id: "sv2a-205g",
    cardNo: "sv2a-205g",
    name: "Mew ex Gold Card (金夢幻 ex UR)",
    jpName: "ミュウ ex UR",
    set: "Pokémon 151",
    rarity: "UR",
    delta: 30,
    deltaDirection: "down",
    images: ["https://picsum.photos/seed/poke-goldmew/600/420"],
    type: "超能力 (Psychic)",
    stage: "Basic",
    weakness: "惡 x2",
    retreatCost: "◆",
    ...
    soldHistory: [{ date: "2026-06-11", grade: "PSA 9", price: 620 }],
    chartPoints: [{ day: 1, date: "06-01", price: 620 }],
    sellOrders: [
      {
        sellerName: "西環電力站",
        sellerId: "HKCV-3322-55A",
  ...
  },
  {
    id: "sv2a-202",
    cardNo: "sv2a-202",
    name: "Blastoise ex SAR (水箭龜 ex)",
    jpName: "カメックス ex SAR",
    set: "Pokémon 151",
    rarity: "SAR",
    delta: 50,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-blastoise/600/420"],
    type: "水 (Water)",
    stage: "Stage 2",
    weakness: "雷 x2",
    retreatCost: "◆◆◆",
    moveDamage: "加農水炮 280",
    artist: "Mitsuhiro Arita",
    soldHistory: [{ date: "2026-06-13", grade: "CGC 10", price: 950 }],
    chartPoints: [{ day: 1, date: "06-01", price: 950 }],
    sellOrders: [
      {
        sellerName: "藍田玩具商",
        sellerId: "HKCV-4433-66B",
  ...
  },
  {
    id: "sv2a-203",
    cardNo: "sv2a-203",
    name: "Alakazam ex SAR (胡地 ex)",
    jpName: "フーディン ex SAR",
    set: "Pokémon 151",
    rarity: "SAR",
    delta: 40,
    deltaDirection: "up",
    images: ["https://picsum.photos/seed/poke-alakazam/600/420"],
    type: "超能力 (Psychic)",
    stage: "Stage 2",
    weakness: "惡 x2",
    retreatCost: "◆◆",
    moveDamage: "精神碎裂 220",
    artist: "shizurow",
    soldHistory: [{ date: "2026-06-14", grade: "Raw Card", price: 550 }],
    chartPoints: [{ day: 1, date: "06-01", price: 550 }],
    sellOrders: [
      {
        sellerName: "九龍城無框生品",
        sellerId: "HKCV-9977-11D",
